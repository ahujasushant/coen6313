...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'about.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/about.html'`` the file from the app1 package is loaded,
    by loading ``'app2/about.html'`` the file from the second.
    """
